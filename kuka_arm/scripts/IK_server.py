...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        Simplified_T0_2 = simplify(T0_1 * T1_2) 
        Simplified_T0_3 = simplify(T0_2 * T2_3) 
        Simplified_T0_4 = simplify(T0_3 * T3_4) 
        Simplified_T0_5 = simplify(T0_4 * T4_5) 
        Simplified_T0_6 = simplify(T0_5 * T5_6)
        Simplified_T0_G = simplify(T0_6 * T6_7)  
